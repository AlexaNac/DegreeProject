...
namespace WebApplication1.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        private static void AddCellToHeader(PdfPTable tableLayout, string cellText)
        {
            ...
            {
                HorizontalAlignment = Element.ALIGN_LEFT, Padding = 5, BackgroundColor = new iTextSharp.text.BaseColor(119, 136, 153)
            });
        }
        ...
        public async Task<ActionResult> Save(employee emp)
        {
            ...
            using (var _context = new ProjectDBContext())
            {
                ...
                return RedirectToAction("Details", "Employee", new { id = employeeDB.employee_id });
            }
        }
        ...
        public async Task<ActionResult> Create(EmployeeViewModel model)
        {
            ...
            return RedirectToAction("Details","Employee", new { id = newemp.employee_id});
        }
