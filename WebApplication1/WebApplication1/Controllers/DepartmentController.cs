    ...
    public class DepartmentController : Controller
    {
        ...
        public ActionResult Details(Guid id)
        {
            ...
            using (var _context = new ProjectDBContext())
            {
                ...
                dep.department = _context.departments.FirstOrDefault(e => e.department_id == id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Save(DepartmentViewModel dep)
        {
            if (!ModelState.IsValid)
            {
                RedirectToAction("Edit", "Department", dep.department.department_id);
            }
            department departmentDB;
            using (var _context = new ProjectDBContext())
            {
                departmentDB = _context.departments.Single(e => e.department_id == dep.department.department_id);
